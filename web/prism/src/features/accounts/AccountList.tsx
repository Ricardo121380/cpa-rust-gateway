...
export type AccountListRow = Readonly<{key:string;name:string|undefined;source:string|undefined;provider:string;authentication:string;status:ReactNode;connection:ReactNode;actions:ReactNode;selected?:boolean;onSelect?:()=>void}>;
