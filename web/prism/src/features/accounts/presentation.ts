...
// Only provider/export identity fields are names; import labels and internal IDs are not.
export function accountName(identity: AccountIdentity | undefined, _label?: string): string | undefined {
  return identity?.email || identity?.phone || identity?.username || undefined;
}
