...
export const CONNECTION_PRESETS = [
  ...
  {id:"kimi",name:"Kimi · API",kind:"kimi",channel:"kimi-api",adapter:"openai-compatible.chat-completions",format:"openai/chat-completions",base:"https://api.moonshot.cn/v1",path:"/chat/completions",fixed:false,native:false},
