...
| 当前任务 | P9-06：实现 REST/gRPC-Web Quota、Tier、Window、Source/Confidence。P8-07、P7-09 和 P9-09 均为 `DEFERRED`；P9 不读取或使用它们的 Credential，也不发送真实 Web 请求。 |
...
| P9-06 | 实现 REST/gRPC-Web Quota、Tier、Window、Source/Confidence | P9-03 | Quota Fixture | IN_PROGRESS |
