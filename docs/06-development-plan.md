...
| P12-10I-14 | 组成 native Web production Statsig/session transport，并通过 CPAR base URL/client key 做真实 HTTP E2E | [local receipt](reports/evidence/p12-10i-14-web-native-runtime-local-receipt-20260806.md) 与 [review](reports/evidence/p12-10i-14-web-native-runtime-local-review-20260806.md)：固定 Web/index/signer targets、Chrome transport、70-byte signature、1h singleflight cache、并发安全的一次 403 refresh、live decoder、native Web account pool、text-only capability 与三协议 Canonical 外投影已本地闭合；待 exact-revision 签名 ARM artifact、Oracle 隔离 HTTP E2E 与 rollback | IN_PROGRESS_ARTIFACT_E2E |
