...
| P12-10H | grok2api 停服回滚演练、CPAR 合成观察与 HTTP E2E | [100-cycle synthetic receipt](reports/evidence/p12-10h-grok-synthetic-100-receipt-20260804.md)、[native route live E2E receipt](reports/evidence/p12-10h-grok-cpar-e2e-live-20260804.md)、[account recovery / Console multi receipt](reports/evidence/p12-10h-grok-account-recovery-console-multi-20260804.md)、[Console public curl receipt](reports/evidence/p12-10h-grok-console-cpar-curl-20260804.md) 与 [review](reports/evidence/p12-10h-grok-console-cpar-curl-review-20260804.md)：Build 自动 refresh 1/1 成功但 828 个永久 `reauthRequired` 未恢复；5 个 Console active 账号逐一原生探针 5/5 通过，但当前 CPAR 公共 `/v1/models` 无可见 Grok route，Console curl 预检零推理发送；Build HTTP E2E 在第 27 次因 provider rate limit 停止 | BLOCKED |
