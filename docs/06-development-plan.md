...
| P12-10I-14 | 组成 native Web production Statsig/session transport，并通过 CPAR base URL/client key 做真实 HTTP E2E | P12-10I-13；须先完成源码 parity、固定 target/credential/session 绑定、失败归因与本地 review；签名制品、隔离 route、真实请求和 rollback 合并一次执行 | IN_PROGRESS |
