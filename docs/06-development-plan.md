...
| 当前阶段 | `P1` 至 `P6`、P9、P10、P11 与 CPAR 侧 P12 已完成（P12 为 `DONE_WITH_BOUNDARY`）；P13-04、P13-05、P13-06A/B/C、P13-07A/B/C/D、P13-08、P13-09A/B/C、P13-10A、P13-11A/B/C/D、P13-11E E0-E3 与独立 P13-11E4 均已通过对应正式 Delivery Gate 并以 `DONE_WITH_BOUNDARY` 收口。P13-11E4 由 `phase-p13-provider-egress-status-complete` / exact `ce98faa9306d076f5af53b9eef0c818abb1cb9c8` / [Gate 32110872875](https://github.com/Ricardo121380/cpa-rust-gateway/actions/runs/32110872875) 正式验收；P13-11 umbrella 因所有已授权切片均已验收而收口为 `DONE_WITH_BOUNDARY`，E5 真实网络仍作为独立 `DEFERRED_UNAUTHORIZED` 边界，不占用活动任务状态。P13 umbrella 因 P13-12 与新增 P13-15 正在实施而继续 `IN_PROGRESS`。P7 Kiro OAuth、P8 Official API-key E2E 与 Grok Web 外部 egress/真实网络边界继续延后。Autoreg 的注册、登录、SSO/OAuth、凭证 refresh/修复和 replenishment 不属于 CPAR/P12；CPAR 对已导入账号的 entitlement observation、credential pool Health/Quota/Circuit、lease、cooldown、failure feedback、调度与上游模型目录仍属于 CPAR，按 `CR-P12-AUTOREG-SEPARATION-001/002`、`CR-P13-ACCOUNT-TIER-001` 与 `CR-P13-UPSTREAM-MODEL-CATALOG-001` 解释。 |
| 当前任务 | `P13-15B Provider/channel discovery composition`：P13-15A 已以 revision-bound ARM64 artifact 上线，生产 `/v1/models` 不再广告 `grok-cpar-build`，真实 Build Responses 与 Pi 0.84.3 均以 exact `grok-4.5` / OpenAI Responses / `/v1` 通过。下一片为所有渠道的 exact Endpoint/Credential-scoped discovery source；不能把当前 compiler-retained Candidate 投影误称为全渠道动态透传。P13-12 后端与生产 `supergrok` authoritative backfill 已完成，仍等待 Claude Code 前端同步与 formal Gate。 |
...
> 当前版本置顶变更：`v1.313`（2026-09-02）见下方第一行；历史版本保持原样。
