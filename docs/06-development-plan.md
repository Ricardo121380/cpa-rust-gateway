...
| 当前任务 | P11-03 至 P11-05 已完成本地实现、review 和证据，等待 P11 Phase Gate；P11-06 正在执行优雅停机、流 Drain、崩溃重启、磁盘满和事件队列降级验证，它是唯一 `IN_PROGRESS` Task。 |
...
| P11-06 | 验证优雅停机、流 Drain、崩溃重启、磁盘满和事件队列降级 | P11-02 | Recovery Report | IN_PROGRESS |
