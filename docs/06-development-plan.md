...
| 当前任务 | `P5-02`：实现 `count_tokens` Canonical 路由和 Provider Capability；无准确能力时明确拒绝。 |
...
| P5-02 | 实现 `count_tokens` Canonical 路由和 Provider Capability；无准确能力时明确拒绝 | P5-01 | 准确路径和 Unsupported 测试 | IN_PROGRESS |
