...
| 当前任务 | P9-07：实现 WAF/EgressRejected 与账号级 Forbidden 证据分离。P8-07、P7-09 和 P9-09 均为 `DEFERRED`；P9 不读取或使用它们的 Credential，也不发送真实 Web 请求。 |
...
| P9-07 | 实现 WAF/EgressRejected 与账号 Forbidden 分离 | P9-02,P9-03 | 403 分类矩阵 | IN_PROGRESS |
