...
| P12-10I-10 | Autoreg SSO→Build/Console/Web 隔离矩阵与 batch-scoped probe 修正 | [Autoreg SSO provider matrix](reports/evidence/p12-10i-10-autoreg-sso-provider-matrix-20260805.md) 与 [review](reports/evidence/p12-10i-10-autoreg-sso-provider-matrix-review-20260805.md)：SSO→Build 转换/导入通过；探针修正 whole-pool cardinality 假设并待重建制品复测；Console 为 `EgressRejected/egress`；Web 因超过 90 天 session lifetime fail closed；生产无 Grok route | BLOCKED_WITH_EVIDENCE |
