...
## 2026-09-21 - Codex - shared K3 high visual adaptation

**What:** `web/prism/src/design/workspace.css`, `src/main.tsx`, removal of billing-owned shared inline CSS and `e2e/workspace-visual.spec.ts`; production adaptation notes and remaining ledger.
...
## 2026-09-23 - Codex - V2 fixed visual closeout

**What:** `web/prism/src/app/v6.css`, `design/modal.css`, `features/access/{AccessPage.tsx,IssueKeyDialog.tsx,access.css}`, `features/models/{ConnectModelDialog.tsx,models.css}`, `features/monitoring/{RequestHistory.tsx,requests.css}`, `features/settings/settings.css`, `features/usage/{UsageCosts.tsx,UsagePage.tsx,usage.css}`.
