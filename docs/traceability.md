...
| P4-05 | Plan 10；Matrix `E19`、`G20`、`G26`；`BL-17` | [ADR-0028](adr/ADR-0028-exact-target-runtime-quota-and-controlled-reset-recovery.md)、[BC-CRED-002](contracts/BC-CRED-002-exact-target-runtime-quota-and-controlled-reset-recovery.md) | `gateway-router` bounded exact-target quota snapshots, source/confidence/reset evidence, 429 ownership, pre-lease quota filtering, and controlled recovery ticket | [P4-05 报告](reports/p4-05-runtime-quota-recovery.md) | LOCAL_PASS_PENDING_CI |
