...
| P3-04 | Plan 9；Matrix `D12`、`D14`、`D17`、`E16`、`K06`、`L26`；Behavior 3/14/17/20 | [ADR-0014](adr/ADR-0014-endpoint-credential-pool-leases.md)、[BC-CRED-001](contracts/BC-CRED-001-endpoint-credential-pool-leases.md) | `gateway-control` AEAD/AAD pool compiler, `gateway-upstream` bounded atomic Credential leases, and `gateway-router` two-stage selection | [P3-04 report](reports/p3-04-endpoint-credential-pool.md) | IN_PROGRESS |
