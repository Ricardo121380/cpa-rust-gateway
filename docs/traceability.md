...
| P6-01 | Plan 12；Matrix `C02`、`C28`、`E06-E10` | [ADR-0042](adr/ADR-0042-grok-build-oauth-credential-boundary.md)、[BC-CRED-003](contracts/BC-CRED-003-grok-build-oauth-device-code.md) | `provider-grok` bounded strict OAuth JSON import, redacted zeroizing credential, injected Device Code state machine, and synthetic no-network evidence | [P6-01 报告](reports/p6-01-grok-build-oauth.md) | LOCAL_PASS_PENDING_PHASE_GATE |
