...
| P4-09 | Plan 10；Matrix `G01`、`G03`、`G15`、`G22`、`K08` | [ADR-0031](adr/ADR-0031-default-deny-log-redaction-and-body-sampling.md)、[BC-OBS-004](contracts/BC-OBS-004-default-deny-log-redaction-and-body-sampling.md) | `gateway-observability` default-deny Header/Body log records, finite deterministic JSON sampling, recursive redaction, and Secret-leak regressions | [P4-09 报告](reports/p4-09-log-redaction-body-sampling.md) | LOCAL_PASS_PENDING_CI |
