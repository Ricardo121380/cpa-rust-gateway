...
| P3-06 | Plan 9；BL-05；Matrix `A22`、`E11`、`E12`、`E15`、`E16`、`G21`、`K03-K06`、`L20-L26`、`L30`；Behavior 1/6/17/20 | [ADR-0016](adr/ADR-0016-request-scoped-attempt-orchestration.md)、[BC-ROUTER-003](contracts/BC-ROUTER-003-request-scoped-attempt-orchestration.md) | `gateway-router` request-scoped Attempt selection, exclusion, bounded retry, health mutation, and FSE retry gate | [P3-06 report](reports/p3-06-attempt-orchestrator.md) | IN_PROGRESS |
