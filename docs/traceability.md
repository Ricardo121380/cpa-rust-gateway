...
| P3-10 | Plan 9；Matrix `C16`、`G05`、`G12-G15`、`G21`、`K03-K06`、`L20-L31`；Behavior 1/4/5/9/17/20 | [ADR-0020](adr/ADR-0020-authorized-real-test-endpoint-validation.md)（Proposed）、[BC-E2E-002](contracts/BC-E2E-002-authorized-real-test-endpoint-validation.md)（Proposed） | Shared P3-09/P3-10 test-only aggregation harness plus ignored, explicitly authorized two-target real Endpoint validation; fixed four-call cap, one Attempt per request, bounded reads, and redaction assertions | [P3-10 plan](reports/p3-10-real-test-endpoint-validation.md) | IN_PROGRESS |
