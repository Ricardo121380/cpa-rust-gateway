...
- [P13-11E4 Provider-specific egress management projection](p13-11e4-provider-egress-management-projection.md) — `DONE_WITH_BOUNDARY`; atomic exact source-domain snapshot, retained cursor, protected GET and OpenAPI/Prism/client passed focused local gates; aggregate local Full `43/43`; immutable `phase-p13-provider-egress-status-complete` @ `ce98faa9306d076f5af53b9eef0c818abb1cb9c8` and formal [Gate 32110872875](https://github.com/Ricardo121380/cpa-rust-gateway/actions/runs/32110872875) passed; current source is Build/Console-only, production Web/clearance may be empty, generic compatible remains separate
- [P13-11E4 aggregate Full receipt](evidence/p13-11e4-aggregate-full-20260818.md) — local-preflight Darwin arm64 `43/43` Full from `06:59:51Z` to `07:01:49Z`, corrective source-policy rerun, exact implementation baseline `f62cd0f`, explicit no-network/non-production boundary, and successor formal-closeout pointer
- [P13-11E4 phase review](evidence/p13-11e4-phase-review-20260818.md) — `DONE_WITH_BOUNDARY`; independent review PASS, goal-backward acceptance matrix, Build/Console-only source boundary and exact formal tag/Gate evidence
...
- [P13-11E E0-E3 phase review](evidence/p13-11e-phase-review-20260817.md) — no remaining P1/P2 blocker; `DONE_WITH_BOUNDARY`; `phase-p13-provider-egress-complete` / `ba2261a5414fe73d147a102a266abd3e9a7fbb5b` / formal [Gate 32044424886](https://github.com/Ricardo121380/cpa-rust-gateway/actions/runs/32044424886) passed; E4 `DEFERRED_OPTIONAL`, E5 `DEFERRED_UNAUTHORIZED`
- [P13-12 Provider/channel-scoped account entitlement](p13-12-provider-account-entitlement.md) — local backend pass for separated Grok Build/Web/Console, ChatGPT/Codex and Claude tier namespaces, strict evidence provenance, migration 0020, protected management projection and exact-batch Build sync; production backfill, Claude Code contract/UI sync and formal Gate remain pending
- [P13-15A exact upstream model serving](p13-15a-exact-upstream-model-serving.md) — Client-Key-authorized exact candidate IDs replace advertised CPAR aliases, exact-ID requests constrain route candidates, duplicate cross-Route IDs fail closed, and Grok Build cache identity is tenant-isolated; real all-channel discovery/materialization and formal Gate remain P13-15B-E
- [P13-15B Build/Codex discovery + P13-16A runtime OAuth refresh](p13-15b-build-codex-discovery-and-p13-16a-refresh.md) — exact-Credential upstream catalog sources preserve observed Build/Codex IDs, while startup/periodic refresh performs encrypted CAS and atomic runtime replacement for the active refreshable channels; production acceptance and remaining catalog/channel slices are still pending
- [P13-15C/D durable catalog and exact-Credential materialization](p13-15c-d-durable-catalog-materialization.md) — migration 0021 retains target-local last success/freshness/removal evidence, the protected status API exposes safe operational fields, and Build/Codex observations atomically materialize exact Credential-restricted routes pinned across ingress and selection; Grok Build now has [Oracle production acceptance](evidence/p13-15c-d-oracle-production-acceptance-20260903.md), while remaining channels, E isolation and the formal gate are pending
