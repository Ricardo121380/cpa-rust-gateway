...
- [P13-15C/D durable catalog and exact-Credential materialization](p13-15c-d-durable-catalog-materialization.md) — migration 0021 retains target-local last success/freshness/removal evidence, the protected status API exposes safe operational fields, and Build/Codex observations atomically materialize exact Credential-restricted routes pinned across ingress and selection; production and remaining channel/E gates are pending
