...
Verification: the reopened P6 continuity test again proves two Client Keys cannot read one another's affinity, missing break evidence rejects rebinding, and a successful rebind leaves one durable break row. It remains locally passed until the single new P6 Delivery Gate.
