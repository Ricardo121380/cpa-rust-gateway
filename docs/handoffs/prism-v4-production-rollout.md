...
**后续更新：** 用户随后要求从其他设备通过既有cpar域名验收。该入口已经接通，当前运行c7cfd2c，
详见 [最新域名交接](prism-domain-access.md)。以下保留首次V4发布及其私有入口/回滚现场记录，
不应将其旧HTTP浏览器origin或down22方案直接用于当前域名版本。

## 首次V4发布状态（历史）

- 本次首次上线：`18f29a3be34422eb30ea7621bdf61459628b8d5f`。
