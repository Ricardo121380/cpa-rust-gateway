...
- [ADR-0096 Config-Version-owned compatible proxy-pool management](ADR-0096-config-version-compatible-proxy-pool-management.md) — `P13-11D LOCAL_PASS_PENDING_PHASE_GATE`（D1/D2/D3 已本地实现；aggregate Full/正式 Gate 待执行）
