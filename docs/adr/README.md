...
- [ADR-0097 Provider-specific egress, health, and recovery isolation](ADR-0097-provider-specific-egress-health-recovery.md) — `P13-11E E0-E3 READY_FOR_FORMAL_DELIVERY_GATE`（aggregate Full 43/43 与 phase review PASS；Build/Console 仅 typed Direct、Web 仍 transport-free；E4 `DEFERRED_OPTIONAL`、E5 未授权，未调用 Provider/网络）
