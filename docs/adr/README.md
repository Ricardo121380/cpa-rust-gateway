...
- [ADR-0092 Public OpenAI Responses WebSocket over the Canonical execution path](ADR-0092-public-responses-websocket.md) — `P13-10A`（Accepted；`LOCAL_PASS_PENDING_PHASE_GATE`；不授权 Provider/生产流量）
