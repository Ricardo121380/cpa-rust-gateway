...
- [ADR-0096 Config-Version-owned compatible proxy-pool management](ADR-0096-config-version-compatible-proxy-pool-management.md) — `P13-11D`（D1/D2 `LOCAL_PASS_PENDING_PHASE_GATE`；D3 runtime composition 尚未开始）
