...
- [ADR-0097 Provider-specific egress, health, and recovery isolation](ADR-0097-provider-specific-egress-health-recovery.md) — `P13-11E E0 PLANNED_REVIEWED`（Build/Console/Web、generic endpoint 与其他 Provider 的状态域和恢复边界已冻结；未开始代码、Provider 或网络验证）
