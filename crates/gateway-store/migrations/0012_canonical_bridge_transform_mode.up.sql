CREATE TABLE route_candidates_canonical_bridge (
    ...
    transform_mode TEXT NOT NULL CHECK (transform_mode IN ('passthrough', 'canonical', 'lossless_bridge', 'canonical_bridge')),
...
INSERT INTO route_candidates_canonical_bridge (
...
ALTER TABLE route_candidates_canonical_bridge RENAME TO route_candidates;
