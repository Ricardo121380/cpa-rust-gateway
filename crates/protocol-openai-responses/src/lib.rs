...
mod tests {
    ...
    fn rejects_duplicate_json_names_at_every_nesting_level() {
        for request in [
            ...
            r#"{"model":"gateway-model","input":[{"type":"function_call","call_id":"history-call","name":"lookup","arguments":"{\"city\":\"Berlin\",\"city\":\"Tokyo\"}"}]}"#,
    ...
    fn rejects_mismatched_tool_argument_deltas() -> TestResult {
        ...
        let events: Vec<CanonicalEvent> = serde_json::from_str(
            r#"[
              ...
              {"tool_call_arguments_delta":{"call_id":"call-01","delta":"{\"city\":\"Berlin\"}","extensions":{}}},
