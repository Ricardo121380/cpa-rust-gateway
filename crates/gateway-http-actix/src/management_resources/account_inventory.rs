...
pub(super) async fn list(
  ...
  loop {
   ...
   for row in page.items {
    ...
    if (kind=="oauth_json"&&matches!(text(&value,"category"),"codex"|"kimi"))||(claude_authorization&&text(&value,"category")=="claude"&&text(&value,"authentication")=="oauth")||(kiro_authorization&&text(&value,"category")=="kiro"&&text(&value,"authentication")=="oauth"){operations.push("reauthorize")}
