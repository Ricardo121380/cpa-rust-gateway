...
allowed = {
  ...
  "gateway-control" => %w[gateway-access gateway-auth gateway-catalog gateway-core gateway-observability gateway-protocol gateway-router gateway-store gateway-upstream serde_json zeroize],
  ...
  "gateway-router" => %w[arc-swap gateway-access gateway-auth gateway-catalog gateway-continuity gateway-core gateway-protocol gateway-provider gateway-upstream tokio],
