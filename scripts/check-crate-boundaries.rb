...
allowed = {
  ...
  "gateway-router" => %w[arc-swap gateway-access gateway-auth gateway-catalog gateway-continuity gateway-core gateway-provider gateway-upstream],
  ...
  "gateway-upstream" => %w[bytes gateway-auth gateway-core gateway-provider moka reqwest tokio url],
