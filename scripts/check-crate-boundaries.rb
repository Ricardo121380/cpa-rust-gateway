...
allowed = {
  ...
  "provider-grok" => %w[gateway-continuity gateway-core gateway-provider gateway-store gateway-upstream protocol-openai-responses rusqlite serde serde_json url zeroize],
