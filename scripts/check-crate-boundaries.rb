...
allowed = {
  ...
  "provider-grok" => %w[flate2 gateway-continuity gateway-core gateway-provider gateway-store gateway-upstream getrandom protocol-openai-responses rusqlite serde serde_json time tokio url zeroize],
