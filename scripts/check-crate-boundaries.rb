...
allowed = {
  ...
  "gateway-http-actix" => %w[actix-web futures-util gateway-auth gateway-control gateway-core gateway-observability gateway-protocol gateway-router gateway-stream gateway-upstream protocol-anthropic protocol-openai-responses provider-openai-compatible serde_json tokio],
