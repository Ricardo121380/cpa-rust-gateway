...
allowed = {
  ...
  "provider-grok" => %w[flate2 gateway-continuity gateway-core gateway-provider gateway-store gateway-upstream getrandom hmac protocol-openai-responses rusqlite serde serde_json sha2 time tokio url zeroize],
