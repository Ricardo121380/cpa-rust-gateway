...
The public roadmap is tracked in [`docs/06-development-plan.md`](docs/06-development-plan.md).
It describes product capabilities and open-source contribution priorities without exposing
private deployment history, host topology, account operations or rollback material.

公开路线图见 [`docs/06-development-plan.md`](docs/06-development-plan.md)。其中只记录产品能力和
开源贡献方向，不包含私有部署历史、主机拓扑、账号操作或回滚材料。
...
- [Public verification policy / 公开验证策略](docs/reports/README.md)
